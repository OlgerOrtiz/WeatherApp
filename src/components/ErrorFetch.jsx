    ...
    <div className="Container__Error">
      <div className='Card__Content--Error'>
        <div className="Card__Error--Image">
          <img src="../public/image/icon-warning.jpg" alt="icon-Warning" />
        </div>
        <div className="Card__Error--Header">
          <h1 className='Card__Error--Title'>{handleError?.message}</h1>
          <img src="../public/image/icon-location.png" alt="icon-location" />
          <img src="../public/image/icon-failed.png" alt="icon-failed" />
        </div>
